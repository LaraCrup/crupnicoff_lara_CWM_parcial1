<template>
    <div v-if="show" class="fixed inset-0 bg-dark/60 flex items-center justify-center">
        <div class="relative w-[88vw] max-h-[95vh] flex flex-col gap-6 bg-light rounded-xl py-10 px-4 md:max-h-[90vh] md:max-w-[588px] lg:max-h-[95vh]  lg:max-w-2xl lg:w-full lg:p-12">
            ...
            <HabitUpdateCard class="w-full h-max md:max-w-full" :username="habitData.profiles.display_name" :posted_at="new Date(habitData.created_at).toLocaleDateString()"
